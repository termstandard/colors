...
terminal while "True Color" denotes that you can display 16 million different
Colors at the same time.

True Color escape codes do not use a Color palette. They just specify the
Color itself.
...
- [MobaXterm](http://mobaxterm.mobatek.net/) **Windows platform** - closed
  source (run `lscolors` to see a true color test)
