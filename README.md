...
- before running these scripts, you can download and inspect them by:
    ...
    wget \
      ...
      https://github.com/robertknight/konsole/raw/master/tests/color-spaces.pl \
    ...
    # read one of the script with your editor
    $EDITOR 24-bit-color.sh
    # if you trust it, make it executable and run it
